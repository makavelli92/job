...
namespace LevelStrategy
{
    public partial class MainForm : Form
    {
        ...
        public MainForm()
        {
            ...
            Task.Run(() => {
                data.CycleSetCommand(data.SW_Command, data.SR_FlagCommand, data.SW_FlagCommand);
            });
        }
        ...
        private void dataGridView1_RowHeaderMouseDoubleClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            if (data.listBars.Count > 0)
            {
                ...
                {
                    form.dataGridView1.Rows.Add(temp.Name, i.SignalType, i.DateBsy, i.DateBpy1, i.DateBpy2, i.Level, i.Lyft, i.CancelSignal);
                }
            }
        }
